...
export default function ClaimDonationPage() {
  ...
  return (
    <div>
      <div className="absolute bg-transparent top-0 bottom-0 left-0 right-0  min-h-screen bg-transparent text-gray-100   flex align-middle justify-center p-4 sm:p-6 md:p-8 -z-40">
