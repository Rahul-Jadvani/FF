    ...
    const handleScroll = () => {
      if (parallaxRef.current) {
        ...
        if (rect.top < window.innerHeight && rect.bottom > 0) {
          parallaxRef.current.style.transform = `translateY(${(scrolled - rect.top) * 0.1}px)`;
        }
      }
    };
    ...
    <div className="relative bg-black py-32 overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative">
        <div className="max-w-4xl mx-auto mb-20 animate-fade-in">
          ...
          <p className="text-xl text-gray-400">Powerful tools designed to maximize impact and efficiency in food redistribution.</p>
        </div>
