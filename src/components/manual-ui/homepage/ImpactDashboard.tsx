  ...
  return (
    <div className="bg-gray-900 py-24">
      <div className="container mx-auto px-6">
        <h2 className="text-4xl font-bold text-center text-white mb-16">Social Impact Dashboard</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="bg-gradient-to-br from-purple-500/20 to-purple-600/20 rounded-xl p-8 text-center backdrop-blur-lg">
            <TreePine className="w-12 h-12 text-purple-400 mx-auto mb-4" />
            <div className="text-4xl font-bold text-white mb-2">2,500kg</div>
            <div className="text-gray-400">CO₂ Emissions Saved</div>
          </div>
          <div className="bg-gradient-to-br from-blue-500/20 to-blue-600/20 rounded-xl p-8 text-center backdrop-blur-lg">
